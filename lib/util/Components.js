 ...
 */
function getUtils(context, components) {
...
function componentRule(rule, context) {
  ...
  const utils = getUtils(context, components);
...
module.exports = Object.assign(Components, {
  /**
   * @param {(context: import('eslint').Rule.RuleContext, components: Components, utils: ReturnType<typeof getUtils>) => any} rule
   */
  detect(rule) {
